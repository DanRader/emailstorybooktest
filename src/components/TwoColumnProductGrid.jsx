...
export const TwoColumnProductGrid = ({ 
  items = [
    {
      href: '#',
      imageSrc: 'https://via.placeholder.com/267x267?text=Product+1',
      itemName: 'Product Name 1',
      shopName: 'Shop Name'
    },
    {
      href: '#',
      imageSrc: 'https://via.placeholder.com/267x267?text=Product+2',
...
export const TwoColumnProductGridHTML = (items = [], ctaHref = '#', ctaLabel = 'Shop all') => {
  ...
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="padding:0 16px 40px;"><tr>${itemsHTML}</tr><tr><td colspan="2" style="padding-top:24px;"><a href="${ctaHref}" style="display:inline-block;padding:10.5px 32px;border-radius:24px;background:#FAF8F5;border:2px solid #332F2E;color:#332F2E;font:700 18px Helvetica,Arial,sans-serif;line-height:130%;text-decoration:none;">${ctaLabel}</a></td></tr></table>`;
};

export default TwoColumnProductGrid;

      ...
      <tbody>
        ...
        <tr>
          <td style={{ paddingTop: '12px' }}>
            <a href={copyHref} style={{ textDecoration: 'none', color: '#332F2E' }}>
              <p style={{ margin: 0, font: '400 18px Helvetica,Arial,sans-serif', lineHeight: '130%', textAlign: 'left' }}>
                {copy}
              </p>
            </a>
          </td>
        ...
        <tr>
          <td style={{ paddingTop: '24px' }}>
            <EtsyCTA href={ctaHref} variant="primary">{ctaLabel}</EtsyCTA>
          </td>
        </tr>
      </tbody>
    </table>
